  ...
  return (
    <Dialog.Root>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="overflow-hidden inset-0 md:inset-auto fixed md:left-1/2 md:top-1/2 md:-translate-x-1/2 md:-translate-y-1/2 md:max-w-[648px] md:w-full md:h-[60vh] bg-slate-700 md:rounded-md flex flex-col outline-none">
          ...
          <form className="flex-1 flex flex-col">
            ...
            {isRecording ? (
              <button
                ...
                className="w-full flex items-center justify-center gap-2 bg-slate-900 py-4 text-center text-small text-slate-300 outline-none font-medium hover:bg-slate-100"
              >
